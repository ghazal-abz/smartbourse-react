                        ...
                        <div className="col-lg-5">
                            <div className="work_info">
                                <div className="section_title">
                                    <h3 className="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">درباره ما</h3>
                                ...
                                <a href="" className="video_watch d-flex align-items-center">
      
                                        <span className="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".7s"> بیشتر بدانید</span>
                                        
                                        <div className="play_btn wow fadeInRight" data-wow-duration="1s" data-wow-delay=".6s">
                                            <a href="https://www.youtube.com/watch?v=D7tF-cY2M9o" className="video_icon popup-video"> <i className="fa fa-arrow-left"></i> </a>
                                        </div>                                 
                                </a>
                            </div>
                        </div>
